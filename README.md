...
> **注意：** 本项目仍在快速开发阶段，功能和接口可能随时变动。如遇到 Bug 或有改进建议，欢迎提 [Issue](https://github.com/monaican/comic-lens/issues) 或 [Pull Request](https://github.com/monaican/comic-lens/pulls)。
>
> **限制：** 当前对长篇漫画（>50 图）的效果未经充分验证，建议优先使用短篇漫画试用。
...
| :control_knobs: | **自动 / 手动模式** | 自动模式四阶段一键跑完；手动模式每阶段暂停，可审核修改后再继续 |
